...
},{}],"wow.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
...
},{}],"siriwave.js":[function(require,module,exports) {
var define;
...
Player.prototype = {
  ...
  play: function play(index) {
    ...
    if (data.howl) {
      ...
      sound = data.howl = new _howler.Howl({
        src: [
  ...
  volume: function volume(val) {
    ...
    _howler.Howler.volume(val); // Update the display on the slider.
...
var player = new Player([{
  ...
  file: "Taizé_song_-_El_alma_que_anda_en_amor(256k).mp3",
  howl: null
}, {
  ...
  file: "Behüte_mich,_Gott.mp3",
  howl: null
}, {
  title: "Cantarei ao Senhor",
  file: "Taizé_-_Cantarei_ao_Senhor(256k).mp3",
  howl: null
}, {
  title: "Bless the lord my soul",
  file: "Taizé-Bless_the_Lord.mp3",
  howl: null
}, {
  title: "Dans nos obscurités",
  file: "Dans_nos_obscurités(256k).mp3",
  howl: null
}, {
  title: "Ven espiritu de Dios",
  file: "VEN_ESPIRITU_DE_DIOS.mp3",
  howl: null
}, {
  title: "Bleibet hier",
  file: "Bleibet_hier.mp3",
  howl: null
}, {
  title: "De noche iremos",
  file: "De_noche_iremos-_Taizé(256k).mp3",
  howl: null
}, {
  title: "In the Lord I'll Be Ever",
  file: "In_the_Lord_I'll_Be_Ever_(El_Senyor)(256k).mp3",
  howl: null
}, {
  title: "Jesus Remember Me",
  file: "Taizé_-_Jesus,_Remember_Me(256k).mp3",
  howl: null
}, {
  title: "Magnificat Anima Mea Dominum",
  file: "Taizé_-_Magnificat_Anima_Mea_Dominum(256k).mp3",
  howl: null
}, {
  title: "Mon âme se repose",
  file: "Taizé_-_Mon_âme_se_repose(256k).mp3",
  howl: null
}, {
  title: "Nada te turbe",
  file: "Taizé_-_Nada_te_turbe(256k).mp3",
  howl: null
}, {
  title: "Laudate omnes gentes",
  file: "Taize_Laudate_omnes_gentes(256k).mp3",
  howl: null
}, {
  title: "Aber du weißt den Weg für mich",
  file: "Taizé_song_-_'Aber_du_weißt_den_Weg_für_mich'_+_LYRICS(256k).mp3",
  howl: null
}, {
  title: "Holy Spirit come to us",
  file: "Taize'_song_-_Holy_Spirit_come_to_us(256k).mp3",
  howl: null
}, {
  title: "I am sure I shall see",
  file: "Taizé_song_-_I_am_sure_I_shall_see(256k).mp3",
  howl: null
}, {
  title: "In manus tuas Pater",
  file: "Taize_song_-_In_manus_tuas_Pater(256k).mp3",
  howl: null
}, {
  title: "The Kingdom of God",
  file: "The_Kingdom_of_God_-_Taizé(256k).mp3",
  howl: null
}, {
  title: "Cristo Jesus",
  file: "Cristo-Jesus.mp3",
  howl: null
}, {
  title: "Wait for the Lord",
  file: "WAIT_FOR_THE_LORD_(Taize)(256k).mp3",
  howl: null
...
resize();
},{"howler":"../../node_modules/howler/dist/howler.js"}],"validation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkEmail = exports.checkLength = void 0;
...
var checkLength = function checkLength(input, min, max) {
  ...
  if (input.value.length < min) {
    showError(input, "".concat(getFieldName(input), " debe contener al menos ").concat(min, " caracteres"));
    error = true;
  } else if (input.value.length > max) {
    showError(input, "".concat(getFieldName(input), " debe contener maximo ").concat(max, " caracteres"));
    error = true;
  } else {
    showSuccess(input);
...
var emailForm = document.getElementById("send-form");
...
if (formEdit) {
  formEdit.addEventListener("submit", function (e) {
    ...
    var description = document.getElementById("texto-");
    var titleLengthError = (0, _validation.checkLength)(title, 6, 70);
    var descriptionLengthError = (0, _validation.checkLength)(description, 100, 10000);
    var imageCoverFile = e.target[1];
    var imagesFiles = e.target[2];

    if (imagesFiles.files.length > 0 && imagesFiles.files.length < 4 || imagesFiles.files.length > 4 || imageCoverFile.files.length === 0 && imagesFiles.files.length > 0 || imagesFiles.files.length === 0 && imageCoverFile.files.length > 0) {
      e.preventDefault();

      _sweetalert.default.fire({
        text: "Para Editar tu publicacion debes seleccionar nuevamente todas las fotos, o puedes dejar esos campos vacios y editar el resto de la publicacion",
...
if (formNew) {
  formNew.addEventListener("submit", function (e) {
    ...
    var descriptionLengthError = (0, _validation.checkLength)(description, 100, 10000);
    var imagesFiles = e.target[2];
    var imageCover = e.target[1];

    if (titleLengthError || descriptionLengthError) {
      e.preventDefault();
    } else if (imagesFiles.files.length !== 4 || imageCover.files.length !== 1) {
      e.preventDefault();

      _sweetalert.default.fire({
        text: "Debes seleccionar una imagen principal y cuatro imagenes acompañantes",
        confirmButtonColor: "#17a29b",
        buttonsStyling: "false"
      });
    } else {
...
if (formRegister) {
  formRegister.addEventListener("submit", function (e) {
    ...
    var usernameLengthError = (0, _validation.checkLength)(username, 4, 30);
    var passwordLengthError = (0, _validation.checkLength)(password, 6, 25);
...
if (emailForm) {
  emailForm.addEventListener("submit", function (e) {
    ...
    var emailLengthError = (0, _validation.checkEmail)(email);
    var nombreLengthError = (0, _validation.checkLength)(nombre, 5, 30);
    var mensajeLengthError = (0, _validation.checkLength)(mensaje, 10, 3000);
